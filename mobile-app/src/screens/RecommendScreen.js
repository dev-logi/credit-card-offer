...
export default function RecommendScreen() {
  ...
  const handleQuickSelect = (storeName) => {
  ...
  const getNetworkBadge = (cardName) => {
          ...
          <View style={styles.resultsContainer}>
            <View style={styles.resultsHeader}>
              <Text variant="titleLarge" style={styles.resultsTitle}>
                💳 Recommendations for {recommendation.merchant_info.merchant_name}
              </Text>
            ...
            {recommendation.merchant_info.identified_categories.length > 0 && (
              <View style={styles.categoriesContainer}>
                {recommendation.merchant_info.identified_categories.map((cat, idx) => (
